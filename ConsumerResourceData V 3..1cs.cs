...
namespace ConsumerResourceModelFramework
{
    ...
    public class CRF_DataItem
    {
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Gets from fluxs. </summary>
        ///
        /// <value> from fluxs. </value>
        ///-------------------------------------------------------------------------------------------------
        ...
        public double SumOnItem(CRF_DataItem TargetItem, CRF_FluxList)
        {
            double result = 0;

            foreach(CRF_Flux Flux in FToFluxs) 
            return result;
        }
        ///-------------------------------------------------------------------------------------------------
    ...
    public class CRF_FluxList : List<CRF_Flux>
    {
        ...
        /// <summary>   Adds anItem. </summary>
        ///
        /// <remarks>   Mcquay, 1/25/2016. Must be a unique item</remarks>
        ///
    ...
    public class CRF_Resource : CRF_DataItem
    {
       ...
       // CRF_FluxList FFluxList;

        public CRF_Resource() : base()
        {
        }
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Constructor. </summary>
        ...
        protected virtual void ResetLimit(double NewLimit)
        {
            ...
            if (NewLimit > FValue)
            {
                // Two conditions, if allocation is based on if TO allocations are permitted.
    ...
    public class CRF_Network
    {
        ...
        public CRF_Network(string Name, CRF_ResourceList aResourceList, CRF_ConsumerList aConsumerList, NetworkResetDelegate Callback)
            : base()
        {
            //foreach (CRF_Consumer Con in aResourceList)
            //{
            //    Con.TheNet = this;
            //}
